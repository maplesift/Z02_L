        ...
        <div id="mm">
            ...
            <div class="hal" id="main">
                <div>
                    ...
                    <span style="width:99%; display:inline-block;">
                        <marquee behavior="" direction="" style="width: 75%;">請民眾踴躍投稿電子報，讓電子報成為大家相互交流、分享的園地！詳見最新文章
                        </marquee>
						<!-- login============ -->
						 <?php 
						 if(isset($_SESSION['user'])){
							...
							echo "<a href='?do=login' style='width: 23% ;'>會員登入</a>";
						 }
						 ?>
